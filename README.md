...
The Keeper Secret Manager provider requires the `keeper-secrets-manager-core` library. This can easily be installed along with the plugin using the following command:

...
| [Vaultwarden](https://github.com/dani-garcia/vaultwarden) (Bitwarden-compatible) | Personal- and organization-owned Login items: password, username, notes, TOTP seed, custom fields                                                                                                             | Email + Master Password (PBKDF2-SHA256 or Argon2id KDF; auth via password-grant OAuth flow). Org items use RSA-OAEP-unwrapped per-org symmetric keys. Session caching via Django cache.                                                                                                                                                                                                                |

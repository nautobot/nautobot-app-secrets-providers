...
| [Bitwarden CLI / Vaultwarden](https://bitwarden.com/products/secrets-manager/) | [Secrets Manager: key/value pairs](https://bitwarden.com/help/about-secrets-manager/) | [Client credentials API key](https://bitwarden.com/help/api-access-tokens/) |
